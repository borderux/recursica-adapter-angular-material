# Timeline — Implementation Notes (pre-implementation stub)
...
- **Notes**: No Timeline component or CDK primitive. Build from scratch (custom CSS connectors + `MatList`/plain markup), same as Beam's finding.
