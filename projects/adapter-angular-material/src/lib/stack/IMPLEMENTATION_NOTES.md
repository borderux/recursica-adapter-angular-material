# Stack — Implementation Notes (pre-implementation stub)
...
- **Notes**: Same conclusion as Flex (Q5) — build as a light wrapper around plain CSS flexbox (column direction), as a real Angular component.
