# Tabs — Implementation Notes (pre-implementation stub)
...
- **Category**: EASY
- **Angular Material / CDK candidate**: `MatTabGroup`/`MatTab` (`tabs.d.ts`)
- **Notes**: Direct match: `animationDuration`, dynamic tab content via `MatTabContent`, `(selectedTabChange)`.
