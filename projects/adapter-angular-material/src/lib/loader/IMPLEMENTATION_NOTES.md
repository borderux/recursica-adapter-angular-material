# Loader — Implementation Notes (pre-implementation stub)
...
- **Notes**: `mode` (`determinate/indeterminate`), `value`, `diameter`, `strokeWidth` — direct conceptual match to Mantine's Loader.
