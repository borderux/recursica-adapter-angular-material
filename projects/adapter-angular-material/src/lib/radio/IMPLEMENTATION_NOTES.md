# Radio — Implementation Notes (pre-implementation stub)
...
- **Angular Material / CDK candidate**: `MatRadioButton`/`MatRadioGroup` (`radio.d.ts`)
- **Notes**: Same gap pattern as Checkbox — no description/helperText/error slot on the bare control.
