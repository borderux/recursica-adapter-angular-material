# Breadcrumb — Implementation Notes (pre-implementation stub)
...
- **Notes**: Not in the package at all, at any capability level — no `mat-breadcrumb`, no CDK primitive for it either. Build from plain `<nav><ol>` + CDK a11y for keyboard/ARIA conventions.
